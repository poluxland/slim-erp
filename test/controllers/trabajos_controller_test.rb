...
class TrabajosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabajo" do
    assert_difference('Trabajo.count') do
      post trabajos_url, params: { trabajo: { detalle: @trabajo.detalle, factura: @trabajo.factura, ito: @trabajo.ito, op: @trabajo.op, terminado: @trabajo.terminado, valor: @trabajo.valor } }
    end
  ...
  test "should update trabajo" do
    patch trabajo_url(@trabajo), params: { trabajo: { detalle: @trabajo.detalle, factura: @trabajo.factura, ito: @trabajo.ito, op: @trabajo.op, terminado: @trabajo.terminado, valor: @trabajo.valor } }
